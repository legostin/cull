...
func (m model) viewHelp(b *strings.Builder, contentWidth int) string {
	...
	lines = append(lines,
		...
		"    m            toggle treemap view (BROWSE tab)",
		"    h/j/k/l      move between rectangles (map view)",
		"    h            toggle hidden files (list view)",
		"    t            cycle sort mode: size / name / updated / created (BROWSE tab); size / idle (PROJECTS tab)",
		"    space        Quick Look preview (macOS)",
		"",
		"  MOUSE",
		"    click        move cursor · click tab name to switch",
		"    double-click enter directory / zoom into map rectangle",
		"    right-click  toggle select",
		"    wheel        scroll · hold Shift/Option to select terminal text",
		"    (disable with --no-mouse)",
		"",
		"  OTHER",
		"    ?            show this help",
		"    q / ctrl+c   quit",
